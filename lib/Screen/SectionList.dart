...
class SectionList extends StatefulWidget {
  ...
  SectionList({
    Key? key,
    this.index,
    this.section_model, required this.from,this.productList
  }) : super(key: key);
...
class StateSection extends State<SectionList> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
     // key: scaffoldKey,
      appBar: getAppBar(
        widget.from==1?sectionList[widget.index!].title!:"You might also like",
        context,
      ),
                          ...
                          child: Stack(
                            children: <Widget>[
                              widget.from==1?listType
                                  ? ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        return (index ==
                                            ...
                                            : listItem(index,widget.section_model!
                                            .productList!.length);
                                      },
                                    )
                                  : GridView.count(
                                ...
                                const AlwaysScrollableScrollPhysics(),
                                itemBuilder: (context, index) {
                                  return listItem(index,widget.productList!
                                      .length);
                                },
                              ),
  ...
  Widget listItem(int index,int len) {
    if (index < len) {
      ...
      double price = double.parse(model
