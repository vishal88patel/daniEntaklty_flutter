      ...
      try {
        ...
        apiBaseHelper.postAPICall(manageCartApi, parameter).then((getdata) {
          ...
          if (!error) {
            ...
            if (!ISFLAT_DEL) {
              if (addressList.isNotEmpty && (oriPrice) < double.parse("0")) {
                delCharge =
                    double.parse(addressList[selectedAddress!].deliveryCharge!);
              } else {
                delCharge = 0;
  ...
  Future<void> placeOrder(String? tranId) async {
    ...
    if (_isNetworkAvail) {
      ...
      if (response.statusCode == 200) {
        ...
        setSnackbar(response.reasonPhrase.toString(), context);
        context.read<CartProvider>().setProgress(false);
      }
    } else {
      if (mounted) {
                ...
                ? Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "${addressList[selectedAddress!].address!},${addressList[selectedAddress!].city!}, ${addressList[selectedAddress!].state!}, ${addressList[selectedAddress!].country!}, ${addressList[selectedAddress!].pincode!}",
