                                              ...
                                              if (mounted) {
                                                setState(() {
                                                  ...
                                                  if (value!) {
                                                    ...
                                                    print(
                                                        "totalPrice***$totalPrice***$usedBal***$isStorePickUp****$delCharge");
                                                    totalPrice =
                                                       totalPrice +
                                                           (isStorePickUp ==
                                                               "false"
                                                               ?(usedBal-delCharge):usedBal);
                                                    print(
                                                        "totalPrice11****$totalPrice");
