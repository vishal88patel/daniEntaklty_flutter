...
class StateItem extends State<ProductDetail> with TickerProviderStateMixin {
  ...
  Future<void> createDynamicLink() async {
    ...
    Share.shareFiles([imageFile.path],text: "share this item");
          ...
          apiBaseHelper.postAPICall(getProductApi, parameter).then(
                ...
                if (!error) {
                  ...
                  if(extPro==null)
                    ...
                    tempList.removeWhere((element) => element.id==widget.model!.id);
                    mostFavProList.addAll(tempList);
                  }
  ...
  _mostFav() {
    return mostFavProList.isNotEmpty?Padding(
                        ...
                        Container(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return productItemView(index, mostFavProList,context,detail1Hero);
                            },
                          ),
                        ),
                      ] )
  ...
  Widget _slider() {
    ...
    print("current hero****$currentHero${widget.index}${widget.model!.id}${widget.secPos}");
    ...
    return GestureDetector(
      ...
      child: Stack(
        children: <Widget>[
          Hero(
              tag: "$currentHero${widget.index}${widget.model!.id}${widget.secPos}",
              child: Container(
            ...
            Row(
              children: <Widget>[
                Text(
                  ...
                  ' ${widget.model!.prVarientList![pos].price!} Puff ',
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return (index == productList.length &&
                                        ...
                                        ? simmerSingle()
                                        : productItemView(index,productList,context,detailHero);
                                  },
                                )))
                        : Container(
                            height: 0,
